...
from infer.onnx_engine import ONNXEngine
from infer.utility import check_gpu, parse_args, get_config_path
...
class TextDetector(ONNXEngine):
    def __init__(self, args):
        ...
        onnx_path = os.path.join(args.det_model_dir, 'ch_PP-OCRv4_server_det.onnx')
        config_path = os.path.join(get_config_path(), 'ch_PP-OCRv4_server_det.yaml')
